...
export const templateConfig = {
  features: {
    blog: {
      ...
      files: ['src/pages/blog/', 'src/pages/rss.xml.js', 'src/utils/blog.ts', 'src/content/'],
    ...
    api: {
      ...
      dependencies: [],
      files: ['src/pages/api/', 'src/pages/api-test.astro'],
      astroIntegrations: [],
    },
    ...
    newsletter: {
      ...
      files: ['src/components/Newsletter.astro', 'src/pages/api/newsletter.ts'],
      astroIntegrations: [],
    },
